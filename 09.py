...
class ConverterFrame(ttk.Frame):
    def __init__(self, container, unit_from, converter):
        ...
        self.temperature_label = ttk.Label(self,
text=self.unit_from)
...
textvariable=self.temperature)
        self.temperature_entry.grid(column=1, row=0, sticky='w',
**options)
...
# radio buttons
        ...
        ttk.Radiobutton(
            ...
            command=self.change_frame).grid(column=0, row=0, padx=5,
pady=5)
        ...
        ttk.Radiobutton(
            ...
            value=1,
            variable=self.selected_value,
            command=self.change_frame).grid(column=1, row=0, padx=5,
pady=5)
